...
@section('content')
    <!-- Layout wrapper -->
    <div class="layout-wrapper layout-content-navbar" style="background-color:#222831">
        <div class="layout-container">
            <!-- Menu -->
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo" style="background-color:#F1F6F9">
                    <a href="{{ route('home') }}" class="app-brand-link">
                        <span class="app-brand-text demo menu-text fw-bolder ms-2 text-uppercase">Drive Away<img src="{{ asset('assets/img/favicon/favicon.ico') }}" alt="bnas" width='50px'></span>
                    </a>
                ...
                <ul class="menu-inner py-1" style="background-color:#DBDFEA">
                    <!-- Dashboard -->
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                            <div class="mb-2 mb-md-0">
                                Developed By Mohtashim [FA20-BCS-126] &copy;
                                <script>

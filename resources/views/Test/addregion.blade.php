            ...
            <div class="row" >
                <div class="col-md-12">
                    ...
                    <div class="card" style='background-color:#AEE2FF'>
                        ...
                        <div class="card-body">
                            <form action="{{ route('region') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4 col-sm-12 mb-3">
                                        <label class="form-label" for="basic-default-name">Region Name</label>
                                        <input type="text" class="form-control @error('name') is-invalid @enderror " value="{{old('name')}}"
                                            id="name" name="region" placeholder="Name of Region">
                                        @error('name')

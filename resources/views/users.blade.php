                                    ...
                                    @if (count($users) > 0)
                                        ...
                                        @foreach ($users as $user)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('users_update', ['id' => $user->id]) }}" id="{{ $user->id }}">
                                                    <button type="button" id="{{ $user->id }}"
                                                        class="btn btnEditUsres btn-sm btn-s rounded-pill btn-icon btn-outline-info" id="{{ $user->id }}">
                                                        <span class="tf-icons bx bx-edit"></span>
                                                    </button>
                                                    </a>
                                                    
                                                    <a href="{{ route('users_destroy', ['id' => $user->id]) }}" id="{{ $user->id }}">
                                                    <button type="button" id="{{ $user->id }}"
